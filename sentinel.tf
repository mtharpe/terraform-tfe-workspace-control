...
# workspace_external_ids = ["${tfe_workspace.aws_terraform_demo_setup.id}", "${tfe_workspace.azure_terraform_demo_setup.id}", "${tfe_workspace.gcp_terraform_demo_setup.id}", ]
#}
